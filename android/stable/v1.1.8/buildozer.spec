...
# (str) Adaptive icon of the application (used if supported by launcher, API 26+)
...
# (list) Permissions
android.permissions = INTERNET,ACCESS_NETWORK_STATE,WAKE_LOCK,FOREGROUND_SERVICE,POST_NOTIFICATIONS,FOREGROUND_SERVICE_DATA_SYNC,REQUEST_IGNORE_BATTERY_OPTIMIZATIONS

# (list) Background services to start
services = Worker:service/main.py:foreground:sticky:foregroundServiceType=dataSync
...
# (str) Release signing keystore
android.keystore = %(source.dir)s/wathome-release.jks
android.keyalias = wathome
android.keystore_password = 4yrd6u56u$%%^U45
android.keyalias_password = 4yrd6u56u$%%^U45
